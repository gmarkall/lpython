...
class ASRToNVVMVisitor : public ASR::BaseVisitor<ASRToNVVMVisitor>
{
private:
...
public:
    ...
    ASRToNVVMVisitor(Allocator &al, llvm::LLVMContext &context, std::string infile,
...
Result<std::unique_ptr<LLVMModule>> asr_to_nvvm(ASR::TranslationUnit_t &asr,
...
#endif
    ASRToNVVMVisitor v(al, context, infile, co, diagnostics);
